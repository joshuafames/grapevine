                                    ...
                                    <div class="profile-id text-center mb-4">
                                            ...
                                            <?php
                                                ...
                                                if ($userid != $followerid) {
                                                    if (DB::query('SELECT follower_id FROM followers WHERE user_id=:userid AND follower_id=:followerid', array(':userid'=>$userid, ':followerid'=>$followerid))) {
                                                        ...
                                                        <button class="mt-1 btn button unfollow-btn show gradient-btn" name="unfollow" data-unfollowid="'.$myhandle.'" style="color:#212529;">Following</button>
                                                        ...
                                                        <button class="mt-1 btn button d-none unfollow-btn gradient-btn" name="unfollow" data-unfollowid="'.$myhandle.'">Following</button>
                                        ...
                                        <div class="followers-area padding-x-35">
                                            <div class="followers row">
                                                <div class="col-4"><h5 class="ss-heading ra-heading"><?php echo($nPosts); ?><br><span class="ss-content" style="color: #212529 !important;">Posts</span></h5></div>

                                                <div class="col-4">
                                                    <a href="#" data-toggle="modal" data-target="#listFollowers" style="color: initial !important;">
                                                        <h5 class="followers-n ss-heading ra-heading"><?php echo($nFollowers); ?><br><span class="ss-content" style="color: #212529 !important;">Followers</span></h5>   
                                                    </a>                                                    
                                                </div>

                                                <div class="col-4">
                                                    <a href="#" data-toggle="modal" data-target="#listFollowing" style="color: initial !important;">
                                                        <h5 class="following-n ss-heading ra-heading"><?php echo($nFollowing); ?><br><span class="ss-content" style="color: #212529 !important;">Following</span></h5>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="bio-section padding-x-35 mt-4">
                                            ...
                                            <p class="para bio fs-15">
                                                
                                                <?php 
                                                    $socialSites = '<div class="socials flex-start">
                                                        <span class="m-r-15 fs-25 icon-facebook-square"></span>
                                                        <span class="m-r-15 fs-25 icon-twitter-square"></span>
                                                        <span class="m-r-15 fs-25 icon-snapchat-square"></span>
                                                        <span class="m-r-15 fs-25 icon-youtube"></span>
                                                        <span class="m-r-15 fs-25 icon-instagram"></span>
                                                    </div>
                                                    <div class="featureText m-t-14">
                                                        <p class="para" style="color: #555 !important;">Follow '.$username.' on other social media platforms
                                                    </div>';
                    ...
                    $('[data-followid]').click(function() {
                        ...
                        $.ajax ({
                                ...
                                success: function(r) {
                                    ...
                                    $('.followers-n').html(''+t.nf+'<br><span class="ss-content" style="color: #555 !important;">Followers</span>')
                                },
                                error: function(r) {
                                    console.log(r)
                                }
                    ...
                    $('[data-unfollowid]').click(function() {
                        ...
                        $.ajax ({
                                ...
                                success: function(r) {
                                    ...
                                    $('.followers-n').html(''+t.nofollowers+'<br><span class="ss-content" style="color: #555 !important;">Followers</span>')
                                },
                                error: function(r) {
                                    console.log(r)
                                }
