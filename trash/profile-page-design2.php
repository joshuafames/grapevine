    ...
    <main class="site-main">
        <section class="profile-area" style="background: #f4f4f4 !important;">           
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="account-header m-t-80 w-100 p-rel">
                            ...
                            <div class="short-info bg-white">
                                ...
                                <div class="info">
                                    <div class="account">
                                        <h6 class="username mb-0"><?php echo $username ?></h6>
                                ...
                                <div class="about-account rounded-container mt-4">
                                    ...
                                    <div class="about-info" style="margin-left: 4.3rem;">
                                        <div class="bio-entry-section mb-4">
                                            <p class="r-font text-primary-grey">The Verge Original photography and videography from The Verge, which covers the future of #technology, #science, #art and #culture.<br>Visit the verge.com <?php if (empty($bio)) { echo($socialSites); }else { echo($bio);} ?></p>
                                        </div>
                                        <div class="socials">
                                            <div class="facebook flex-start">
                                                <span class="m-r-15 fs-25 icon-facebook-square"></span>
                                                <h6 class="handle">Kly The Creator</h6>
                                            </div>
                                            <div class="twitter flex-start">
                                                <span class="m-r-15 fs-25 icon-twitter-square"></span>
                                                <h6 class="handle">@kly_thecreator</h6>
                                            </div>
                                            <div class="instagram flex-start">
                                                <span class="m-r-15 fs-25 icon-instagram"></span>
                                                <h6>@kly_thecreator</h6>
                                            </div>
                                        </div>
                    ...
                    <div class="col-lg-3 left-profile-area mt-4">
                        <div class="profile" style="width: 290px !important;">
                            <div class="profile-info mt-0 left-nav left">
                                <div class="info-area mt-0">
                                    <div class="photos3x3 rounded-container mt-0">
                                        ...
                                        <div class="pics flex-start">
                                            <div class="image">
                                                <img src="./img/people/person_1.jpg">
                                            </div>
                    ...
                    <div class="col-lg-9">
                        <div class="row">
                            <div class="col-lg-12" style="margin-top: 1.5rem;">
                                ...
                                <div class="stories-area default mt-0 rounded-container carousel" style="margin-top:0px !important;padding: 2rem;">
