            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 left-profile-area">
                        <div class="profile fixed" style="width: 290px !important;">
                            <div class="profile-info left-nav left">
                                <div class="floating-image">

                                    <a <?php if ($userid == $followerid) {echo ' href="#" data-toggle="modal" data-target="#changeDP"';} ?> >
                                ...
                                <div class="info-area">
                                    <div class="profile-id text-center mb-4">
                                        <h7 class="handle ra-heading mb-4" style="color: #212529;">@<?php echo($myhandle); ?></h7><br/>
                                        
                                    </div>
                                    <div class="photos3x3 rounded-container mt-0">
                                        <h6 class="lc-section-heading grey py-2 mb-3">Photos</h6>
                                        <div class="pics flex-start">
                                            <div class="image">
                                                <img src="./img/people/person_1.jpg" style="width: 70px;border-radius: 7px;">
                                            </div>
                                        ...
                                        <div class="pics flex-start py-3">
                                            <div class="image">
                                                <img src="./img/people/person_1.jpg" style="width: 70px;border-radius: 7px;">
                                            </div>
                                            <div class="image px-3">
                    ...
                    <div class="col-lg-9">
                        <div class="row">
                            <div class="col-lg-12" style="margin-top: 4rem;">
                                ...
                                <div class="account-info m-t-45 m-b-45">
                                    <div class="name-area flex-start">
                                        <h4 class="account-name c-font-light m-b-2 d-flex justify-content-center">
                                            <?php echo $username ?>
                                            <span class="<?php if ($verified) { echo 'icon-check-circle';} ?> ml-2 mr-3" style="color: #007bff;"></span>                                            
                                        </h4>
                                        <div class="cta-area ml-3">
                                            <?php
                                                $btnSECT = "";
                                                if ($userid != $followerid) {
                                                    if (DB::query('SELECT follower_id FROM followers WHERE user_id=:userid AND follower_id=:followerid', array(':userid'=>$userid, ':followerid'=>$followerid))) {
                                                        ...
                                                        echo '<button class="text-white btn button d-none follow-btn gradient-btn" name="follow" data-followid="'.$myhandle.'">Follow</button>

                                                        <button class="btn button unfollow-btn show gradient-btn" name="unfollow" data-unfollowid="'.$myhandle.'" style="color:#212529;">Following</button>

                                                        <button class="ml-1 btn button dm-button gradient-btn">
                                                                <img style="width: 20px;" src="./vendors/ionicons-5.1.2/paper-plane-outline.svg">
                                                        </button>';

                                                    }else {
                                                        echo '<button class="btn button show follow-btn gradient-btn" name="follow" data-followid="'.$myhandle.'">Follow</button>

                                                        <button class="btn button d-none unfollow-btn gradient-btn" name="unfollow" data-unfollowid="'.$myhandle.'">Following</button>
                                                        ...
                                                        echo '<a href="usersettings.php">
                                                                <button class="mt-1 btn button unfollow-btn gradient-btn" name="unfollow" style="color:#212529;">Edit Profile</button></a>
                                    ...
                                    <div class="interaction-info my-4">
                                    ...
                                    <div class="bio-area">
                                        <p class="r-font-reg text-primary-grey">The Verge Original photography and videography from The Verge, which covers the future of #technology, #science, #art and #culture.<br>Visit the verge.com <?php if (empty($bio)) { echo($socialSites); }else { echo($bio);} ?></p>
                                    </div>
                                </div>

                                <!--<div class="stories-area featured col rounded-container carousel" style="background: url('./img/unorganised/puria-berenji.jpg'); padding: 4rem;">
                                    <div class="profilehead p-rel text-center text-white">
                                        <h1 class="title r-font-bold">CATION</h1>
                                        <p>Programmer | Graphic Designer | Extrovert | Dreamer</p>
                                    </div>                                    
                                </div>--->
                                
                                <div class="stories-area default rounded-container carousel" style="padding: 2rem;">
                                    <div class="area-heading flex-start relative mb-1 mt-1">
                                        <h5 class="lc-section-heading mb-4">Featured Stories</h5>                               
                                    </div>
                                ...
                                <!--<div class="np-area px-4 py-4">
                                    <h5 class="lc-section-heading mb-4 text-black">Featured Stories</h5>
                                    <div class="flex-start">
                                        <div class="single-item rounded-container">
                                            <div class="np-dp-area"></div>
                                        </div>
                                    </div>
                                </div>--->
